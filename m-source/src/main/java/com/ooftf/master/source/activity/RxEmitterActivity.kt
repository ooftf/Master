...
import com.ooftf.master.source.databinding.ActivityRxEmitterBinding
...
class RxEmitterActivity : BaseBarrageActivity() {
    ...
    lateinit var binding: ActivityRxEmitterBinding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityRxEmitterBinding.inflate(layoutInflater)
        ...
        binding.onComplete.setOnClickListener {
            if (emitter == null) {
                addBarrage("emitter == null")
            } else {
                emitter?.onComplete()
