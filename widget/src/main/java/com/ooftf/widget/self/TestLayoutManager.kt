 ...
 */
class TestLayoutManager : androidx.recyclerview.widget.RecyclerView.LayoutManager() {
    ...
    var totalHeight = 0
    private fun calculateChildrenSite(recycler: androidx.recyclerview.widget.RecyclerView.Recycler) {
        totalHeight = 0
